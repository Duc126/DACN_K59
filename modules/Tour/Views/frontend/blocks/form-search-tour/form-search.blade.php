<form action="{{ url(config('tour.tour_route_prefix')) }}" class="form bravo_form_search_tour" method="get">
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            <div class="form-group form-date-field form-date-search clearfix  has-icon" data-format="DD/MM/YYYY">
                ...
                <input type="hidden" class="check-in-input" value="{{Request::query('start',date("d/m/Y",strtotime("today")))}}" name="start">
